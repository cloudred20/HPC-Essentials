...
Brief introduction to using the command line for basic bioinformatics tasks, including logging in, navigating the file system, working with software modules, submitting jobs with Slurm, and fundamentals of the HPC.
